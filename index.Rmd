...
Este manual está disponible en el repositorio Github: [diegochiquero/ciberseguridad-consciente](https://github.com/diegochiquero/ciberseguridad-consciente). Y ha sido escrito en [R-Markdown](http://rmarkdown.rstudio.com) empleando el paquete [`bookdown`](https://bookdown.org/) cuya guia encontrarás en [@R-bookdown].
