...
Participo en talleres, charlas y proyectos comunitarios donde transformo dudas reales en prácticas sencillas que cualquiera puede aplicar. Para mí, la seguridad no es solo una batería de soluciones rápidas, sino una actitud y una filosofía para prestar atención, entender lo que hacemos y tomar decisiones informadas en un mundo cada vez más automatizado.

En la era de la inteligencia artificial, mi objetivo es ayudarte a navegar un ecosistema donde la tecnología es poderosa, pero también opaca. Aspiro a que esta guía te sirva para usar la web 3.0 con más conciencia, más control y menos fricción.
